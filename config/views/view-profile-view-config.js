...
import {viewProfileTabsConfig} from "../tabs/view-profile-tabs-config";
import ViewProfileBannerBlock from "../../components/blocks/profile/ViewProfileBannerBlock";

export const viewProfileViewConfig = {
    name: PROFILE_VIEW,
    blocks: [
        {
        ...
        },
        {
            ...
            props: {
                config: viewProfileTabsConfig,
                headerComponent: ViewProfileBannerBlock
            },
            access_control: {
