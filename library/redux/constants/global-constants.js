...
export const GLOBAL_MODALS = "global_modals";
export const GLOBAL_MODAL_SHOW = "global_modal_show";
export const GLOBAL_MODAL_TIMEOUT = "global_modal_timeout";
export const GLOBAL_MODAL_NAME = "global_modal_name";
export const GLOBAL_MODAL_SIZE = "global_modal_size";
